	...
	local function SecondaryRanged()
		...
		task.spawn(function()
			...
			task.spawn(function()
				...
				MagicSphere(Vector3.one * 6, 10, bombo.CFrame, Color3.new(1, 0.8, 0.5), Vector3.one * -0.6, Vector3.zero, 0)
				MagicSphere(Vector3.one * 2, 15, bombo.CFrame, Color3.new(1, 0.8, 0.5), Vector3.one * 1.2, Vector3.zero, 0.5)
